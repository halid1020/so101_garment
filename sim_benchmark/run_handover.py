...
Usage:
    python sim_benchmark/run_handover.py                      # 30 x all methods
    python sim_benchmark/run_handover.py --methods pink_relaxed scipy_ls
    python sim_benchmark/run_handover.py --view --methods scipy_ls --scenarios 0
    python sim_benchmark/run_handover.py --save out.json --plot plots/
"""
