...
Usage:
    python sim_benchmark/run_benchmark.py                     # full sweep
    python sim_benchmark/run_benchmark.py --methods pink_full mink
    python sim_benchmark/run_benchmark.py --view --methods dls \
        --trajectories circle_r5cm                            # live viewer
    python sim_benchmark/run_benchmark.py --save out.json
"""
