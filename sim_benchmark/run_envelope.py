...
Usage:
    python sim_benchmark/run_envelope.py                     # full sweep
    python sim_benchmark/run_envelope.py --oob-modes project freeze
    python sim_benchmark/run_envelope.py --methods pink_relaxed telegrip \
