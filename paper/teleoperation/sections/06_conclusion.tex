...
\end{itemize}
Next steps: hardware A/B of \texttt{telegrip} vs.\ \texttt{pink\_relaxed}
on garment-handling primitives; folding the envelope margin into operator
feedback (controller vibration); and extending the envelope to a
self-collision-aware region for bimanual work near the rig center.
