...
Collects documents/teleop_benchmark_results.md (asset paths rewritten),
...
Run after regenerating results:
    venv/bin/python src/sim_benchmark/package_report.py
"""
...
REPORT_MD = REPO_ROOT / "documents" / "teleop_benchmark_results.md"
