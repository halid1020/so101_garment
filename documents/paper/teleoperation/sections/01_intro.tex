...
smoothness directly affects hardware wear and tracking fidelity. \textbf{TODO: explain the third point in more details.}

This document makes five contributions:
\begin{enumerate}
  \item a description of the production retargeting pipeline: grip-clutched
        absolute-position mapping with One-Euro filtering \textbf{TODO: what is this filtering. please explain briefly here and put detailed information in other sections.} and the
  ...
  \item the integration of a \emph{Telegrip-style split IK} \textbf{TODO: introduce the method used in Telegrip repository in great detailes.}
  ...
  \item a within-subjects \emph{user study protocol} (\(n\approx 5\))
        ...
        NASA-TLX workload \textbf{TODO: what is this, explain.}, system usability, custom teleoperation-feel
...
\textbf{TODO: create a preliminary section to introduce the common teleopration details in other system in details. The math formulas, the system data follow. Focus on using meta-quest to contron single or dual arms with 5,6 or 7 DoF. The common teleoperation system design, the common IK methods, the common orientation mapping (wrist control), the common out-of-envelope handling.}

\textbf{TODO: do not put code related document path and class paths in the paper. add this to paper writing guideline.}
