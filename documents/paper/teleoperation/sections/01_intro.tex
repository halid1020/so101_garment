...
\textbf{TODO: mention even though LeRobot is quite popular, but it does not support VR teleopration. you can use LeVR paper to support this point.}

\textbf{TODO: clearly state what kind of challenges we are addressing in this paper.}

\textbf{TODO: mention LeRobot So101 becomes an enducational setup for students and hobboiest. However, it is not convenient to collect data with its leader-follower arms setup. Use reference to support this point. }
