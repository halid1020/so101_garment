...
camera sits within a small fraction of what the number of tokens that camera
contributes would give it regardless of content, and ranks the cameras against
the measured behavioural effect almost in reverse, while the gradient
decomposition ranks them identically to it. Reporting attention as though it
measured importance would therefore have inverted the platform's central
finding. Finally, because an attribution averaged over an episode answers
