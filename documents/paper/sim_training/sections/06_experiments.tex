...
\textbf{TODO: also add optimal flow matching policy to the experiment.}
\textbf{TODO: also add pi 0 probably.}
\textbf{TODO: I will add a new design of a new gripper. We want to create a table/plots to compare two grippers with direct-oracle and teloperation-orcacle on all the tasks.}
\paragraph{Protocol.}
